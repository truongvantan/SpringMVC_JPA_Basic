...
<body>
	...
	<div class="container-fluid">
		...
		<div class="row d-flex justify-content-center">
			<form action="${contextPath}/product/add" method="POST" class="w-75 mt-2">
				<div class="row">
					<div class="col-md-6 col-xs-12">
						<div class="form-outline mb-4">
							<label class="form-label text-primary font-weight-bold"
								...
								placeholder="Tên sản phẩm" value="${param.productName}" />
						</div>
						<div class="form-outline mb-4">
							<label class="form-label text-primary font-weight-bold"
						...
						<div class="form-outline mb-4">
							<label class="form-label text-primary font-weight-bold"
								...
								placeholder="Đơn giá nhập" value="${param.priceIn}" />
						</div>
					</div>
					<div class="col-md-6 col-xs-12">
						<div class="form-outline mb-4">
							<label class="form-label text-primary font-weight-bold"
								...
								placeholder="Đơn giá bán" value="${priceSell.donGiaBan}" />
						</div>
						<div class="form-outline mb-4">
							<label class="form-label text-primary font-weight-bold"
								for="linkImage">Link hình ảnh</label> <input type="text"
								name="linkImage" id="linkImage" class="form-control"
								placeholder="Link hình ảnh" value="${param.linkImage}" />
						</div>
						<div class="form-outline mb-4">
							<label class="form-label text-primary font-weight-bold"
								for="description">Mô tả</label> <input type="text" name="description"
								id="description" class="form-control" placeholder="Mô tả"
	...
	<script>
		$(document).ready(function() {
			$('#listCategories').val('${param.categoryId}');
		});
	</script>
</body>
</html>